...
// 10. The greatest common divisor (https://en.wikipedia.org/wiki/Greatest_commonivisor)
// is the largest integethat, given two other integers, can be divided into them. For
// example, the greatest commdivisor of 24 and 81 is 3. The grtest common divisor of
// 10 and 25 is 5.
//
...
// divisor using the instructions above.
                function gcd(num1,num2) {
                    if (num1 === num 2 && num1 % 2 === 0 && num2 % 2 === 0) {
                        return num1 / 2
                    }
                    if (num 1 !== num 2) {
                        return num1 / 2
